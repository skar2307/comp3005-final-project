...
class PaymentMethodsControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create payment_method" do
    assert_difference("PaymentMethod.count") do
      post payment_methods_url, params: { payment_method: { card_number: @payment_method.card_number, cvv: @payment_method.cvv, expiry_date: @payment_method.expiry_date, members_id: @payment_method.members_id } }
    end
  ...
  test "should update payment_method" do
    patch payment_method_url(@payment_method), params: { payment_method: { card_number: @payment_method.card_number, cvv: @payment_method.cvv, expiry_date: @payment_method.expiry_date, members_id: @payment_method.members_id } }
